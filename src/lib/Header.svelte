        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-2">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a
                            href="https://github.com/ameryu716"
                            class="navbar-brand"
                            style="width: 30px;"
                        >
                            <!-- Github Logo -->
